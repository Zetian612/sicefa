          ...
          <div class="row justify-content-md-center">
                ...
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle"
                      src="{{ asset('bolmeteor/images/imgjerly.jpg') }}" alt="User profile picture">
                  </div>
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b>Mail</b> <a
                        href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJTHWNfxBnrcwVhNqLqTcxHWrdbkSMHhkHWTvcJfLXtXckdLrhKCvKdBKHjnHngCpVdbkXB"
                        class="btn btn-outline-primary float-right"><b><i class="fas fa-envelope-square"></i></b></a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="card card-green card-outline shadow">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="{{ asset('bolmeteor/images/diego.png') }}"
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b>Mail</b> <a
                        href="https://mail.google.com/mail/u/1/#inbox/FMfcgxwLsmlqrpWHwPFghnQdNpbFcchW?compose=new"
                        class="btn btn-outline-primary float-right"><b><i class="fas fa-envelope-square"></i></b></a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="col-md-3">
                  <div class="card card-green card-outline shadow">
                    <div class="card-body box-profile">
                      <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle"
                          src="{{ asset('bolmeteor/images/leidy.png') }}" alt="User profile picture">
                      </div>
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                          <b>Mail</b> <a href="#" class="btn btn-outline-primary float-right"><b><i
                                class="fas fa-envelope-square"></i></b></a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col-md-3">
                  <div class="card card-green card-outline shadow">
                    <div class="card-body box-profile">
                      <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle"
                          src="{{ asset('bolmeteor/images/Leonardo.png') }}" alt="User profile picture">
                      </div>
                ...
                <div class="col-md-3">
                  <div class="card card-green card-outline shadow">
                    <div class="card-body box-profile">
                      <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle"
                          src="{{ asset('bolmeteor/images/Sergio.png') }}" alt="User profile picture">
                      </div>
                ...
                <div class="col-md-3">
                  <div class="card card-green card-outline shadow">
                    <div class="card-body box-profile">
                      <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle"
                          src="{{ asset('bolmeteor/images/Valentin.jpg') }}" alt="User profile picture">
                      </div>
                ...
                <div class="col-md-3">
                  <div class="card card-green card-outline shadow">
                    <div class="card-body box-profile">
                      <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle"
                          src="{{ asset('bolmeteor/images/David.png') }}" alt="User profile picture">
                      </div>
      ...
      <div class="col-md-12">
        <div class="card card-green card-outline shadow">
          ...
          <div class="card-body">
            <div class="row">
              <ul>
                <li>Plantilla AdminLTE de <a href="https://adminlte.io" title="AdminLTE" target="blank">adminlte.io/</a>
                </li>
                <li>Iconos gratuitos de <a href="https://fontawesome.com/icons?d=gallery" title="Flaticon"
                    target="blank"> fontawesome.com</a></li>
                <li>Iconos diseñados por <a href="https://www.flaticon.es/autores/freepik" title="Freepik"
                    target="blank"> Freepik </a> de <a href="https://www.flaticon.es/" title="Flaticon" target="blank">
                    www.flaticon.es</a></li>
              </ul>
