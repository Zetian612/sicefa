  ...
  <nav class="main-header bg-secondary navbar navbar-expand navbar-white navbar-light" style="height: 40px"  id="nav"   >
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        {{-- Sicefa route in index view --}}
        <a href="{{ route('cefa.welcome') }}" class="nav-link">SICEFA</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    @else
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('piscicola.admin.dashboard') }}" class="nav-link {{ ! Route::is('piscicola.admin.dashboard') ?: 'active' }}">Administrador</a>
      </li>
    @endguest  
    </ul>
