...
<nav class="main-header navbar navbar-expand navbar-light navbar-lightblue">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route('cefa.puntoventa.index')}}" class="nav-link">{{ trans('puntoventa::menu.Home') }}</a>
        </li>
        @guest
        @else
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route('puntoventa.admin.dashboard')}}" class="nav-link">{{
                trans('puntoventa::menu.Administrator') }}</a>
        </li>
